 ...
 */
class FundTransferTest17 extends TestCase
{
	private static $last_transfer_txn_ref = "87849"; // @NOTE Duplicate crn
	private $axis_bank;
	...
	// Duplicate transaction test with same CRN
	public function test_case_17_duplicate_transaction_with_same_crn()
	{
		echo "\n" . __FUNCTION__ . "\n";
		$http_client = new HttpClient(
			self::$key_filepath,
